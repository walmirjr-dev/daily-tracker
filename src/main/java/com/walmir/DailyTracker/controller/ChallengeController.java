...
public class ChallengeController {
	...
	@PutMapping(value = "/{id}")
    public ResponseEntity<ChallengeResponseDTO> update(@PathVariable Long id, @RequestBody Challenge newEntity) {
        ChallengeResponseDTO newDto = service.update(id, newEntity);
